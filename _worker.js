...
function processRessHeader(ressBuffer, userID) {
    ...
    switch (addressType) {
        ...
        case 3:
            addressLength = 16;
            const ipv6Parts = new Uint16Array(ressBuffer.buffer, addressValueIndex, addressLength / 2);
